...
const Profile = () => {
  return (
    <div className="bg-[#F7F8F9] w-[375px] h-[800px] border-2 border-gray-200">
      ...
      <div className="px-5 mt-5 space-y-[30px]">
        <div className="flex items-start gap-5 text-[#1D2226]">
          ...
          <div className="space-y-1 ">
            ...
            <p className="text-sm leading-[19px]">Marry@Gmail.com</p>
          </div>
        </div>
        <p className="text-sm text-[#374049] leading-[22px]">
          Lorem Ipsum Dolor Sit Amet, Consetetur Sadipscing Elitr, Sed Diam
          Nonumy Eirmod Tempor Invidunt  Aliquyam Erat,
          Sed Diam
        </p>
      </div>
      <div className=" flex flex-col gap-120">
      <p className="mt-5 border border-dashed border-[#CBCBCB] space-x-4"></p>
       <p className=" mt- border border-dashed border-[#CBCBCB] space-x-4"></p>
       </div>
    </div>
  );
};
