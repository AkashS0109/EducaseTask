  ...
  return (
    <div className="bg-[#F7F8F9] w-[375px] h-[730px] border border-gray-200 px-5 pt-10">
      ...
      <form className="space-y-6 mt-6" onSubmit={handleSubmit}>
        ...
        <button
          type="submit"
          className="bg-[#696969] rounded-md text-white text-base leading-[17px] font-medium w-full h-[46px] cursor-pointer transition-all duration-300 ease-in-out hover:bg-[#5A1EDB] mt-4"
        >
          Login
        </button>
      </form>
